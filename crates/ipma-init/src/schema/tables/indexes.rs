...
pub async fn create(pool: &sqlx::PgPool) -> Result<(), sqlx::Error> {
    let indexes = [
        ...
        "CREATE INDEX IF NOT EXISTS idx_net_outlets_device_port_id ON net_outlets(device_port_id)",
        "CREATE INDEX IF NOT EXISTS idx_net_outlets_peer_net_outlet_id ON net_outlets(peer_net_outlet_id)",
        ...
        "CREATE INDEX IF NOT EXISTS idx_devices_net_outlet_id ON devices(net_outlet_id)",
        "CREATE INDEX IF NOT EXISTS idx_devices_device_port_id ON devices(device_port_id)",

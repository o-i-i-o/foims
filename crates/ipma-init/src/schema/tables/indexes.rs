...
pub async fn create(pool: &sqlx::PgPool) -> Result<(), sqlx::Error> {
    let indexes = [
        ...
        "CREATE INDEX IF NOT EXISTS idx_device_interfaces_network_card_id ON device_interfaces(network_card_id) WHERE network_card_id IS NOT NULL",
        "CREATE INDEX IF NOT EXISTS idx_network_cards_device_id ON network_cards(device_id)",

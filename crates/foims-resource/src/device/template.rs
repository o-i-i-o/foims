...
use foims_models::{DeviceTemplate, DeviceTemplateSummary, UpdateDeviceTemplateRequest};
use serde_json::json;
use std::sync::Arc;
use uuid::Uuid;
...
pub async fn delete_device_template<P: DbProvider>(
    ...
    Ok(foims_common::ok_json((), "server.device_template.deleted"))
}
...
pub async fn update_device_template<P: DbProvider>(
    ...
    Ok(foims_common::ok_json((), "server.device_template.updated"))
}

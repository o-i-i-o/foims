...
use crate::resource::switch::{
    ...
    get_switch, get_switch_arp_table, get_switch_info_snmp, get_switch_port, get_switch_ports,
    get_switch_ports_snmp, get_switches, test_snmp_connection, update_switch, update_switch_port,
};
use crate::resource::{
    ...
    get_cabinet_networks, get_cabinet_position, get_cabinet_position_ips, get_cabinets, get_ip_managers,
    ...
    get_available_ips, auto_assign_ip, batch_create_ip_managers, batch_delete_ip_managers,
};
            ...
            web::scope("/api")
                    ...
                    web::scope("/resources")
                        ...
                        .service(
                            web::scope("/ip")
                                ...
                                .route("/batch", web::delete().to(batch_delete_ip_managers))
                ...
                .service(
                    web::scope("/switches")
                        ...
                        .route("/{id}/test-snmp", web::post().to(test_snmp_connection))
                        .route("/{id}/arp-table", web::get().to(get_switch_arp_table))
                    ...
                    web::scope("/system")
                        ...
                        .service(
                            web::scope("/import-export")
                                .route("/import/json", web::post().to(import_json))
                                .route("/import/csv", web::post().to(import_csv))
                                .route("/import/database", web::post().to(import_database))

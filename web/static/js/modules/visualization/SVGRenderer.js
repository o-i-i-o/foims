export class SVGRenderer {
    ...
    drawUMarks(_cabinet, group, baseX, baseY, width, capacity) {
        const uHeight = 20;
        ...
        for (let i = 1; i <= capacity; i++) {
            ...
            line.dataset.relY1 = String(y - baseY);
            line.dataset.relX2 = String(width - 10);
            line.dataset.relY2 = String(y - baseY);
            ...
            if (i % 5 === 0 || i === 1 || i === capacity) {
                ...
                text.dataset.relX = "5";
                text.dataset.relY = String(y - baseY + uHeight / 2);
    ...
    drawCabinetPosition(position, cabinet) {
        ...
        text.dataset.relY = String(height / 2 + 4);
    ...
    drawDoor() {
        ...
        doorHandle.dataset.relCx = String(width - 10);
        doorHandle.dataset.relCy = String(height / 2);

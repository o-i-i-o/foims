...
export async function loadRoomsData(page = currentPage, sortBy = null, sortOrder = null) {
  ...
  try {
    ...
    if (!roomsSeq.isCurrent(requestSeq)) {
    ...
    const totalPages = retreatToLastPage(rooms, page, data, currentPageSize);
    if (totalPages) {

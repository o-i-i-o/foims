...
export async function initVisualization() {
  ...
  try {
    ...
    document.getElementById("network-region-select").addEventListener("change", (e) => {
    ...
    document
      .getElementById("auto-draw-workstations")
    ...
    document
      .getElementById("auto-draw-cabinet-positions")
      .addEventListener("click", async () => {
        const networkRegionId = document.getElementById("network-region-select").value;
        if (networkRegionId) {
    ...
    document
      .getElementById("save-workstation-layout")
      .addEventListener("click", () => {
        workstationVisualization.saveLayout();
      });

    document
      .getElementById("delete-workstation-layout")
      .addEventListener("click", () => {
        workstationVisualization.deleteLayout();
      });

    document
      .getElementById("save-cabinet-layout")
      .addEventListener("click", () => {
        cabinetVisualization.saveLayout();
      });

    document
      .getElementById("delete-cabinet-layout")
      .addEventListener("click", () => {

...
export function toggleSnmpConfig() {
    ...
    if (v2Config) {
        v2Config.style.display = snmpVersion === "v2c" ? "block" : "none";
    }
    if (v3Config) {
        v3Config.style.display = snmpVersion === "v3" ? "block" : "none";
    }
}
export async function testSnmpConnection(_switchId) {
    try {
        const snmpVersion = elementCache.getValue("switch-snmp-version");
        const config = {
...
//# sourceMappingURL=switchSnmp.js.map
...
import { loadSwitchesData } from "./switchManager.js";
import { loadNetworkTypesData, loadNetworksData, initNetworksSearch } from "./networks.js";
import { loadRoomsData } from "./room.js";
import { loadWorkstationsData } from "./workstation.js";
import { loadCabinetsData } from "./cabinet.js";
import { loadCabinetPositionsData } from "./position.js";
...
export function initResourceTabs() {
  ...
  if (!resourcesContainer) {
    console.warn("resources 容器未找到，跳过初始化");
    return;
  }

...
export const ORG_ICONS = {
  ...
  // 楼层：楼层分隔线
  floor: svgWrap(
    '<rect x="4" y="2" width="16" height="20" rx="1"/><path d="M4 8.5h16M4 15h16M12 2v20"/>'
  ),
  // 区域分区：虚线分区
  zone: svgWrap(
    '<rect x="3" y="3" width="18" height="18" rx="1"/><path d="M12 3v18" stroke-dasharray="2.5 2.5"/><path d="M3 12h18" stroke-dasharray="2.5 2.5"/>'
  ),

  // ---- 功能空间 ----
  // 大厅：廊柱大厅
  hall: svgWrap(
    '<path d="M3 21h18"/><path d="M5 21V10M9.5 21V10M14.5 21V10M19 21V10"/><path d="M2.5 10 12 3l9.5 7"/>'
  ),
  // 前台：服务铃
  reception: svgWrap(
    '<path d="M3 19h18"/><path d="M5 19a7 7 0 0 1 14 0"/><path d="M12 12V9.5"/><circle cx="12" cy="8.5" r="1"/>'
  ),
  // 办公室：公文包
  office: svgWrap(
  ...
  // 机柜：机柜格位
  cabinet: svgWrap(
    '<rect x="5" y="2" width="14" height="20" rx="1"/><path d="M9 6.5h6M9 10.5h6M9 14.5h6M9 18.5h6"/>'
  ),
  // 机位：包裹（机柜中的设备位）
  cabinet_position: svgWrap(

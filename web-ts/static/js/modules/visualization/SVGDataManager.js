    ...
    async fetchIpManager() {
        try {
            ...
            if (result.success && result.data) {
                ...
                if ("ip_managers" in result.data && Array.isArray(result.data.ip_managers))
                    return result.data.ip_managers;
                if ("ips" in result.data && Array.isArray(result.data.ips))
            ...
            if (this.core.type === "workstation") {
                ...
                if (doorItem && doorItem.position) {
                    ...
                    if (circle) {
                        ...
                        circle.dataset.relCx = String(doorItem.position.width - 10);
                        circle.dataset.relCy = String(doorItem.position.height / 2);
                    }
...
//# sourceMappingURL=SVGDataManager.js.map